...
locals {
  telemetry_map = {
    ...
    grafana_dashboard_var_app                 = var.grafana_dashboard_var_app
    grafana_dashboard_var_namespace           = var.grafana_dashboard_var_namespace
    grafana_dashboard_var_rack                = var.grafana_dashboard_var_rack
    grafana_dashboard_var_service             = var.grafana_dashboard_var_service
  ...
  telemetry_default_map = {
    ...
    build_node_minimal_role_enabled           = "false"
    build_node_type                           = ""
    ...
    grafana_dashboard_var_app                 = "app"
    grafana_dashboard_var_namespace           = "namespace"
    grafana_dashboard_var_rack                = "rack"
    grafana_dashboard_var_service             = "service"
    grafana_url                               = ""
    ...
    region                                    = "us-east-1"
    release                                   = ""
    release_watcher_gc_interval               = "5m"
